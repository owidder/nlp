...
class ECMAScriptParser ( Parser ):
    ...
    def sourceElement(self):
        ...
        try:
            ...
            if la_ == 1:
                self.enterOuterAlt(localctx, 1)
                self.state = 120
                if not _input.LA(1) != Function:
                    from antlr4.error.Errors import FailedPredicateException
                    raise FailedPredicateException(self, "_input.LA(1) != Function")
                self.state = 121
                self.statement()
                pass
    ...
    def statement(self):
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.state = 128
                if not _input.LA(1) != OpenBrace:
                    from antlr4.error.Errors import FailedPredicateException
                    raise FailedPredicateException(self, "_input.LA(1) != OpenBrace")
                self.state = 129
    ...
    def getter(self):
        ...
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 608
            if not _input.LT(1).getText().equals("get"):
                from antlr4.error.Errors import FailedPredicateException
                raise FailedPredicateException(self, "_input.LT(1).getText().equals(\"get\")")
            self.state = 609
            self.match(ECMAScriptParser.Identifier)
            self.state = 610
            self.propertyName()
    ...
    def setter(self):
        ...
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 612
            if not _input.LT(1).getText().equals("set"):
                from antlr4.error.Errors import FailedPredicateException
                raise FailedPredicateException(self, "_input.LT(1).getText().equals(\"set\")")
            self.state = 613
            self.match(ECMAScriptParser.Identifier)
            self.state = 614
            self.propertyName()
