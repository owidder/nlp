...
def aggregate_values_in_file(sum_values_file_path: str, current_sum_values: dict, max_values_file_path: str, current_max_values: dict):
...
def aggregate_values_in_subfolder(subdir_path, current_sum_values, current_max_values):
    ...
    for f in os.listdir(folder_path):
        ...
        if(os.path.isfile(full_path)):
            if(f.endswith('tfidf.csv')):
                aggregate_values_in_file(full_path, sum_values, full_path, max_values)
        else:
            aggregate_values_in_subfolder(full_path, sum_values, max_values)
